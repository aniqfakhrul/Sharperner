...
namespace Sharperner.Execution
{
    /// <summary>
    ...
    public static class Win32
    {
        public static class Kernel32
        {
            ...
            public enum StandardRights : uint
            {
                ...
                uhuskcjmufmRead = 0x80000000,
                uhuskcjmufmWrite = 0x40000000,
                uhuskcjmufmExecute = 0x20000000,
                uhuskcjmufmAll = 0x10000000
            }
        ...
        public static class Advapi32
        {
            ...
            public enum SCM_ACCESS : uint
            {
                ...
                uhuskcjmufm_READ = ACCESS_MASK.STANDARD_RIGHTS_READ |
                    SC_MANAGER_ENUMERATE_SERVICE |
                    SC_MANAGER_QUERY_LOCK_STATUS,

                uhuskcjmufm_WRITE = ACCESS_MASK.STANDARD_RIGHTS_WRITE |
                    SC_MANAGER_CREATE_SERVICE |
                    SC_MANAGER_MODIFY_BOOT_CONFIG,

                uhuskcjmufm_EXECUTE = ACCESS_MASK.STANDARD_RIGHTS_EXECUTE |
                    SC_MANAGER_CONNECT | SC_MANAGER_LOCK,

                uhuskcjmufm_ALL = SC_MANAGER_ALL_ACCESS,
            }
            ...
            public enum ACCESS_MASK : uint
            {
                ...
                uhuskcjmufm_READ = 0x80000000,
                uhuskcjmufm_WRITE = 0x40000000,
                uhuskcjmufm_EXECUTE = 0x20000000,
                uhuskcjmufm_ALL = 0x10000000,
